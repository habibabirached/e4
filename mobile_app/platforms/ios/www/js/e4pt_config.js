frame_data = [
    ...
    {'frame':'7FA+e',
     ...
     'spacers':[
         {'stage':'2', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'1.336', 'max':'1.436', 'size':'2.0815', 'color':'BLACK', 'image':'7FA-R5-R10'},
    ...
    {'frame':'7HA.01',
     ...
     'position':{'6':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'],
                 ...
                 '14':['TOP', 'RIGHT', 'BOTTOM', 'LEFT']},
     'spacers':[
         {'stage':'6', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'4.121', 'max':'4.221', 'size':'5.192', 'color':'RED', 'image':'7HA01-R6-1'},
         {'stage':'6', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'4.3', 'max':'4.4', 'size':'5.013', 'color':'BLUE', 'image':'7HA01-R6-2'},
         {'stage':'10', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'6.83', 'max':'6.93', 'size':'2.483', 'color':'GRAY', 'image':'7HA01-R10'},
         {'stage':'14', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'4.191', 'max':'4.291', 'size':'5.122', 'color':'SILVER', 'image':'7HA01-R14-1'},
         {'stage':'14', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'6.83', 'max':'6.93', 'size':'2.483', 'color':'GOLD', 'image':'7HA01-R14-2'}
     ],
    'stage_info':{
         '6':{
             'RIGHT':['A', 350.0, 350.0, 2.718],
    ...
    {'frame':'7HA.02-FL16',
     'stage':['1', '6', '10', '141', '142'],
     'position':{'1':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'],
                 '6':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'],
                 '10':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'],
                 '141':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'],
                 '142':['TOP', 'RIGHT', 'BOTTOM', 'LEFT']},
     'spacers':[
         ...
         {'stage':'141', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'4.159', 'max':'4.259', 'size':'5.154', 'color':'SILVER', 'image':'7HA02-R14-1'},
         {'stage':'142', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'6.531', 'max':'6.631', 'size':'2.782', 'color':'GOLD', 'image':'7HA02-R14-2'}
     ],
    'stage_info':{
        '1':{
    ...
    {'frame':'9FA',
     ...
     'spacers':[
         ...
         {'stage':'5', 'position':['TOP', 'BOTTOM'], 'min':'5.689', 'max':'5.789', 'size':'3.624', 'color':'BLACK', 'image':'9FA-R5TB'},
         {'stage':'10', 'position':['LEFT', 'RIGHT'], 'min':'1.7', 'max':'1.8', 'size':'7.613', 'color':'BLACK', 'image':'9FA-R10LR'},
         {'stage':'10', 'position':['TOP', 'BOTTOM'], 'min':'8.563', 'max':'8.663', 'size':'0.75', 'color':'BLACK', 'image':'9FA-R10TB'},
         {'stage':'10', 'position':['TOP', 'RIGHT', 'BOTTOM', 'LEFT'], 'min':'1.842', 'max':'1.942', 'size':'7.471', 'color':'GREEN', 'image':'9FA-R10-2'},
