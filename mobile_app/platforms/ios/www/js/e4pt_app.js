define(function (require, exports, module) {
  ...
  function updateSensorParameters(mfh, mval, sensor, sensor_length, smr, mr) {
    ...
    // sensor manually
    //Habib: this is where, after we press collect, we are sending message
    console.log("Sending message to E4PT");
    alert("Sending message to E4PT");
    messaging.sendMessage({
      args: [
        {
  ...
  function plot_non_calibrated_acquire() {
    ...
    chartConfig.pointsBetweenBlades = E4PTdata.pointsBetweenBlades;
    ...
    console.log("refz E4PTdata = ", E4PTdata);
  ...
  function plot_calibrated_acquire() {
    ...
    console.log("refz2 E4PTdata = ", E4PTdata);
    charting.displayIntensityThresholdAndMeasurementRate(chartConfig, E4PTdata.measurement_rate, E4PTdata.intensity_threshold);
