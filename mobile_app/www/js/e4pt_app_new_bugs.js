define(function (require, exports, module) {
  ...
  var DEBUG_MODE = false; // todo make this false for product version (Habib)
  ...
  //var CALC_METHOD_CONTROLLER = 3;
  //var CALC_METHOD_NONE = 4;
  var CALC_METHODS = {
    Original: 1,
    New: 2,
    Controller: 3,
  ...
  var archive_db = new PouchDB("e4ptarchive", {
    revs_limit: 1,
    auto_compaction: true,
  });
  ...
  $(document).ready(function () {
    ...
    // added by Habib so I can debug in a browser!
    if (DEBUG_MODE) {
      update_connection_mode("demo");
      serialConnected = false;
      // messaging.sendMessage({
      //   args: [{ command: "set_connection_mode", mode: "demo" }],
      // });
      console.log("DEBUG_MODE active – Forced into demo mode.");
    }
    ...
    document.getElementById("MAIN_MENU").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("FRD_BUTTON").addEventListener(
      "click",
      function () {
        toggleMenu();
        fadeOutAll();
    ...
    document.getElementById("FRD_VIEW_BUTTON").addEventListener(
      "click",
      function () {
        show_FRD();
      },
    ...
    document.getElementById("SETUP_BUTTON").addEventListener(
      "click",
      function () {
        toggleMenu();
        fadeOutAll();
    ...
    document.getElementById("FRAME_SIZE").addEventListener(
      "change",
      function () {
    ...
    document.getElementById("SN_SUBMIT_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("CLEAR_DB_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to clear all data from this database?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("CLEAR_SELECTED_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to delete the selected records?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("ARCHIVE_SELECTED_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to archive the selected records?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("DELETE_ARCHIVE_DB_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to clear and delete all data from this archive and local drive?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("DELETE_SELECTED_ARCHIVE_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to delete the selected archive records?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("UNARCHIVE_SELECTED_BUTTON").addEventListener(
      "click",
      function () {
        e4PtConfirm("Are you sure you want to unarchive the selected records?", function (idx) {
          if (idx == 1) {
    ...
    document.getElementById("OPEN_LOCAL_DATA_BUTTON").addEventListener(
      "click",
      function () {
        fadeOutAll();
        try {
    ...
    document.getElementById("OPEN_ARCHIVE_DATA_BUTTON").addEventListener(
      "click",
      function () {
        fadeOutAll();
        try {
    ...
    document.getElementById("SHUTDOWN_BUTTON").addEventListener(
      "click",
      function () {
        toggleMenu();
        systemShutdown();
    ...
    document.getElementById("CONN_SELECTION").addEventListener(
      "change",
      function () {
        set_connection_mode();
      },
    ...
    document.getElementById("CONFIGURE_CONTROLLER_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("READ_SENSOR_PARAMETERS_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("DATA_PLOT_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("DATA_PLOT3_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("FRD_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
        $("#FRD_PAGE").fadeOut();
      },
    ...
    document.getElementById("SENSOR_SETUP_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("SETUP_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
        $("#SETUP_PAGE").fadeOut();
      },
    ...
    document.getElementById("LOCATION_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("LOCAL_DATA_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("ARCHIVED_DATA_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("FILE_CHOOSER_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("DATA_DETAILS_CLOSE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("GET_DATA_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("SENSOR_SETUP_BUTTON").addEventListener(
      "click",
      function () {
        toggleMenu();
        fadeOutAll();
    ...
    document.getElementById("START_DARK_REFERENCE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("MEASUREMENT_RATE_1").addEventListener(
      "input",
      function () {
        ...
        if (isNaN(sf) || typeof sf !== "number") {
          ...
          messaging.sendMessage({
            args: [{ command: "get_threshold_for_rate", rate: sf.toFixed(3) }],
          });
        }
      },
      { passive: true }
    );
    document.getElementById("SET_MEASUREMENT_RATE_BUTTON").addEventListener(
      "click",
      function () {
        set_measurement_and_intensity_value("MEASUREMENT_RATE_1", "Measurement rate", MIN_SAMPLING_RATE, MAX_SAMPLING_RATE, "THRESHOLD_1", "Intensity Threshold", MIN_INTENSITY, MAX_INTENSITY, {
          ...
          threshold: parseFloat(document.getElementById("THRESHOLD_1").value).toFixed(3),
          rate: parseFloat(document.getElementById("MEASUREMENT_RATE_1").value),
        });
      },
      { passive: true }
    );
    document.getElementById("RESET_MEASUREMENT_RATE_BUTTON").addEventListener(
      "click",
      function () {
        messaging.sendMessage({
          args: [{ command: "set_manual_override", value: false }],
        });
        ...
        messaging.sendMessage({
          args: [{ command: "get_threshold_for_rate", rate: DEFAULT_SAMPLING_RATE }],
        });
      },
      { passive: true }
    );
    document.getElementById("EXPORT_DATA_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("EXPORT_DATA_BUTTON_02").addEventListener(
      "click",
      function () {
        fromDataPlotPage = false;
    ...
    document.getElementById("STAGE_COLLECT_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("COLLECTION_RESET_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("CUSTOMER_REPORT_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("SENSOR_STAGE").addEventListener(
      "change",
      function () {
        set_stage();
        update_spacer_value();
    ...
    document.getElementById("SENSOR_POSITION").addEventListener(
      "change",
      function () {
        set_position();
        update_spacer_value();
    ...
    document.getElementById("CURR_CASE_THICKNESS").addEventListener(
      "change",
      function () {
        update_spacer_value();
      },
    ...
    document.getElementById("SENSOR_PARAMS_UPDATE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("FILE_DELETE_BUTTON").addEventListener(
      "click",
      function () {
        deleteMultipleFiles();
      },
    ...
    document.getElementById("FILE_EXPORT_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("DATA_DETAILS_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("DETAILS_EXPORT_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("SPACER_THUMBNAIL").addEventListener(
      "click",
      function () {
        showSpacerImage();
      },
    ...
    document.getElementById("LOG_CLEAR_BUTTON").addEventListener(
      "click",
      function () {
        clearLog();
      },
    ...
    document.getElementById("LOG_EXPORT_BUTTON").addEventListener(
      "click",
      function () {
        // exportLog();
        saveLog(); // added by Habib so to save on iPad teh console.logs show it in browser and on app
      },
      { passive: true }
    );
    document.getElementById("CALCULATE_RPM_BUTTON").addEventListener(
      "click",
      function () {
        //calculateRPM();
    ...
    document.getElementById("COMPARE_MASTER_BUTTON").addEventListener(
      "click",
      function () {
        compareMasterValue();
      },
    ...
    document.getElementById("LOCATION_BUTTON").addEventListener(
      "click",
      function () {
        showLocationImages();
      },
    ...
    document.getElementById("CALCULATION_MSG").addEventListener(
      "click",
      function () {
        e4PtAlert("Clearance = Displacement + Start of Measuring Range + Sensor Length - Spacer Thickness - Casing Thickness");
      },
      { passive: true }
    );
    document.getElementById("EDIT_BUTTON").addEventListener(
      "click",
      function () {
        edit();
      },
    ...
    document.getElementById("EDIT_SAVE_BUTTON").addEventListener(
      "click",
      function () {
        edit_save();
      },
    ...
    document.getElementById("CLEARANCE_OVERRIDE_BUTTON").addEventListener(
      "click",
      function () {
        clearance_override();
      },
    ...
    document.getElementById("CLEARANCE_OVERRIDE_SAVE_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("FRAME_DATA_CLEAR_BUTTON").addEventListener(
      "click",
      function () {
        clearFrameData();
      },
    ...
    document.getElementById("OPEN_SETTINGS_BUTTON").addEventListener(
      "click",
      function () {
    ...
    document.getElementById("SENSOR_SELECTION").addEventListener(
      "change",
      function () {
    ...
    document.getElementById("MASTER_FIXTURE_HEIGHT").addEventListener(
      "change",
      function () {
    ...
    document.getElementById("MASTERING_VALUE").addEventListener(
      "change",
      function () {
        enableMasteringValuesForEditing(true);
      },
    ...
    document.getElementById("SENSOR_LENGTH").addEventListener(
      "change",
      function () {
        updateMasteringValue();
        enableMasteringValuesForEditing(true);
    ...
    document.getElementById("SMR").addEventListener(
      "change",
      function () {
        updateMasteringValue();
        enableMasteringValuesForEditing(true);
    ...
    document.getElementById("SENSOR_MR").addEventListener(
      "change",
      function () {
        enableMasteringValuesForEditing(true);
      },
    ...
    document.getElementById("TOLERANCE_LABEL").addEventListener(
      "click",
      function () {
  ...
  function saveLog(showDownload = true, saveMode = "file") {
    ...
    // Depending on saveMode, choose how to save the log
    if (true) {
      // (saveMode === "file") {
      // Save to local storage on the iPad
      writeToFile(targetFolder, fileName, contents, function () {
        $("#PROCESSING_PAGE").fadeOut();
        if (showDownload) {
          fileDownloadFunction(fileUrl); // This triggers download or use of the file
        }
        logExported = true;
        if (previousLogFile !== "" && previousLogFile !== fileName) {
          window.resolveLocalFileSystemURL(
            fileDir,
            function (dir) {
              deleteFile(dir, previousLogFile); // Delete old log file
    ...
    if (true) {
      // (saveMode === "browser") {
      // Open the log content in Safari (or browser) as plain text
      let logWindow = window.open("", "_blank");
      logWindow.document.write(`<pre>${contents}</pre>`);
    ...
    if (true) {
      //  (saveMode === "app") {
      // Display log contents directly within the app (e.g., in a modal or div)
      $("#logModal").find(".modal-body").text(contents); // Assuming you have a modal element
      $("#logModal").modal("show");
      $("#PROCESSING_PAGE").fadeOut();
    }
  }
  ...
  function checkWarmup(f) {
    if (!warmedUp) {
      ...
      e4PtConfirm("Sensor not warmed up!\nIt is recommended to wait before proceeding. Do you wish to continue with collection?", function (idx) {
        if (idx == 1) {
          f();
        }
      });
  ...
  function clearFrameData() {
    ...
    e4PtConfirm("Are you sure you want to clear all data and start a new collection?", function (idx) {
      // 1=OK, 2=Cancel
      if (idx == 1) {
  ...
  function acquisitionTimePromptWithMetaDataCallback(results) {
    ...
    if (acquisitionTime != null) {
      ...
      if (checkRPM < MIN_RPM || checkRPM > MAX_RPM) {
        ...
        requestE4PtDataWithMetaData(acquisitionTime, frame, sn, current_stage, current_position, casing_thickness, spacer_thickness, document.getElementById("CLEARANCE_CALCULATION_METHOD").value);
        //    }
        //}
      }
    }
  ...
  function show_FRD() {
    fileviewer2.open(appDir + FRD_FILE, {
      error: function (e) {
        console.log("FRD file error: status=" + e.status + ", message=" + e.message);
      },
      success: function () {
  ...
  function set_connection_mode() {
    ...
    messaging.sendMessage({
      args: [{ command: "set_connection_mode", mode: mode }],
    });
  }
  ...
  function authorizeControllerSettingsUpdate() {
    ...
    if (nav != null) {
      // We have plugins so we're in Cordova.  Use the Cordova notification.
      navigator.notification.prompt("Please enter the password.", confirmControllerSettingsPassword, "Enter Password", ["Ok", "Cancel"], "");
    } else {
      // No plugins, so we must not be in Cordova. Use a standard prompt.
  ...
  function configureController() {
    ...
    if (!serialConnected) {
      ...
      if (messaging.usesPlugin) {
        e4PtConfirm("Are you sure you want to configure the controller?", function (idx) {
          if (idx === 1) {
            messaging.sendMessage({
              args: [{ command: "configure_controller" }],
            });
          }
        });
      } else {
  ...
  function set_position_information() {
    ...
    // updated in set_stage_information
    //selected_frame_data.stageInfoIdx = current_stage_index;
    //selected_frame_data.stageName = current_stage;
    //selected_frame_data.bladeCount = current_frame_data.stage_info[current_stage].blade_count;
  }
  ...
  function set_measurement_and_intensity_value(el_id, label, minVal, maxVal, el_id2, label2, minVal2, maxVal2, cmd) {
    ...
    if (input_f > maxVal) {
      e4PtConfirm(label + "s over " + maxVal + " are not supported. Value will be set to " + maxVal, function (buttonIndex) {
        if (buttonIndex == 1) {
          //OK
          input_f = maxVal;
          document.getElementById(el_id).value = input_f.toFixed(3);
      ...
      e4PtConfirm(label + "s below " + minVal + " are not supported. Value will be set to " + minVal, function (buttonIndex) {
        if (buttonIndex == 1) {
          //OK
          input_f = minVal;
          document.getElementById(el_id).value = input_f.toFixed(3);
      ...
      e4PtConfirm(label2 + "s over " + maxVal2 + " are not supported. Value will be set to " + maxVal2, function (buttonIndex) {
        if (buttonIndex == 1) {
          //OK
          input_f2 = maxVal2;
          document.getElementById(el_id2).value = input_f2.toFixed(3);
      ...
      e4PtConfirm(label2 + "s below " + minVal2 + " are not supported. Value will be set to " + minVal2, function (buttonIndex) {
        if (buttonIndex == 1) {
          //OK
          input_f2 = minVal2;
          document.getElementById(el_id2).value = input_f2.toFixed(3);
  ...
  function override_measurement_rate(cmd) {
    ...
    messaging.sendMessage({
      args: [{ command: "set_manual_override", value: true }],
    });
  ...
  function setButtonProperties(button, text, buttonColor) {
    ...
    button.removeClass(allColors).addClass(targetColor).html(text);
  }
  ...
  function setSpanProperties(span, text, spanColor) {
    ...
    span.removeClass(allColors).addClass(targetColor).html(text);
  }
  ...
  function confirm_reset_data_collection() {
    e4PtConfirm("Are you sure you want to clear all data on this page?", function (idx) {
      if (idx == 1) {
  ...
  function generate_customer_report() {
    //console.log("@generate_customer_report");
  ...
  function setup_data_collection_page(dateStr, timeStr, update_position) {
    ...
    for (stage_index = 0; stage_index < stages.length; stage_index++) {
      ...
      for (position_index = 0; position_index < positions.length; position_index++) {
        ...
        var el_id = positions[position_index] + stages[stage_index];
        el_id = el_id.replace(/\s+/g, "_");
        html_buf.push("<td id='" + el_id + "' onclick='set_grid_position(\"" + positions[position_index] + '", "' + stages[stage_index] + "\")'></td>");
        html_buf.push("</tr>");
      }
        ...
        if (casing_thickness <= max && casing_thickness >= min) {
          for (var j = 0; j < spacers[i].position.length; j++) {
            if (position == spacers[i].position[j]) {
              ...
              spacer = {
                size: spacers[i].size,
                color: spacers[i].color,
                image: spacers[i].image,
              };
              spacer_found = true;
              break;
            }
  ...
  function systemShutdown() {
    ...
    if (messaging.usesPlugin) {
      e4PtConfirm("Are you sure you want to exit?", function (idx) {
        if (idx === 1) {
  ...
  function e4PtPrompt(msg, callback, title, buttonLabels) {
    ...
    try {
      navigator.notification.confirm(String(msg), callback, String(title), buttonLabels);
    } catch (err) {
    ...
    const handleReceivedMessage = function (msg) {
      ...
      switch (msg.type) {
        ...
        case "pong":
          ...
          setTimeout(function () {
            messaging.sendMessage({ args: [{ command: "ping" }] });
          }, 5000);
          break;
        case "filename": {
    ...
    switch (msg.type) {
      ...
      case "progress":
        ...
        $("#REV_PROGRESS")
          ...
          .text(msg.progress + "%");
        break;
      case "sensor_params": // refz_
        //console.log("Received sensor parameters message: master fixture height =", msg.master_fixture_height, ", mastering value =", msg.mastering_value, ", master offset =", msg.master_offset, ", sensor selection =", msg.sensor_selection, ", sensor length =", msg.sensor_length, ", start measurement range =", msg.start_measurement_range, ", sensor measurement range =", msg.sensor_measurement_range);
        console.log("Received sensor parameters message");
        console.log("master fixture height =", msg.master_fixture_height + "in");
        console.log("mastering value =", msg.mastering_value + "mm");
        console.log("master offset =", msg.master_offset + "in");
        console.log("sensor selection =", msg.sensor_selection);
        console.log("sensor length =", msg.sensor_length + "in");
        console.log("start measurement range =", msg.start_measurement_range + "mm");
        console.log("sensor measurement range =", msg.sensor_measurement_range + "mm");
        ...
        // habib
        console.log("msg.sensor_selection__ = ", msg.sensor_selection);
        sensorSettings.set("sensor_selection", msg.sensor_selection);

        let tmp_sensor_length, tmp_sensor_name;
        // when it reads this, the first time, it is zero, the second time, it populates correctly.
        // tmp_sensor_length = sensorSettings.get("sensor_length");

        // but if I read it from msg, it works from the first time.
        tmp_sensor_length = msg.sensor_length;
        console.log("tmp_sensor_length = ", tmp_sensor_length);

        if (tmp_sensor_length > 5) {
          tmp_sensor_name = "LONG";
          document.getElementById("SENSOR_SELECTION").value = tmp_sensor_name;
        } else {
          tmp_sensor_name = "SHORT";
          document.getElementById("SENSOR_SELECTION").value = tmp_sensor_name;
        }

        // if (
        //   ["SHORT", "LONG", "PROTOTYPE", "CUSTOM"].includes(
        //     sensorSettings.get("sensor_selection")
        //   )
        // ) {
  ...
  function authorizeSensorParamsUpdate() {
    ...
    if (nav != null) {
      // We have plugins so we're in Cordova.  Use the Cordova notification.
      navigator.notification.prompt("Please enter the password.", confirmSensorParamsPassword, "Enter Password", ["Ok", "Cancel"], "");
    } else {
      // No plugins, so we must not be in Cordova. Use a standard prompt.
      let pw = window.prompt("Please enter the password.", "1");
      confirmSensorParamsPassword({ input1: pw });
  ...
  function confirmSensorParamsPassword(results) {
    ...
    if (results.input1 == UPDATE_SETTINGS_PASSWORD) {
      updateSensorParameters(document.getElementById("MASTER_FIXTURE_HEIGHT").value, document.getElementById("MASTERING_VALUE").value, document.getElementById("SENSOR_SELECTION").value, document.getElementById("SENSOR_LENGTH").value, document.getElementById("SMR").value, document.getElementById("SENSOR_MR").value);
    } else {
      e4PtAlert("Invalid password.");
    }
  }

  function updateSensorParameters(mfh, mval, sensor, sensor_length, smr, mr) {
    ...
    if (isNaN(mfh_f) || isNaN(mstrval_f) || isNaN(sensor_length_f) || isNaN(smr_f) || isNaN(mr_f)) {
      e4PtConfirm("Please enter only floating point values.\nPlease try again.", function (buttonIndex) {
        if (buttonIndex == 2) {
          //Cancel - This cancels and gets the previous values back.
          getSensorParameters();
        }
      });
      return;
    }
    // todo: probably remove this or remove the button that allows the setting of the
    // sensor manually
    messaging.sendMessage({
      args: [
        {
          command: "set_sensor_parameters",
          hmf: mfh_f.toString(10),
          mv: mstrval_f.toString(10),
          name: sensor,
          length: sensor_length_f.toString(10),
          smr: smr_f.toString(10),
          mr: mr_f.toString(10),
        },
      ],
    });
  ...
  function getSensorParametersForSensorSelection(sensorType) {
    ...
    // todo: remove "custom" and "prototype" from the drop down menu
  ...
  function updateMasteringValue() {
    document.getElementById("MASTERING_VALUE").value = sensorSettings.calculateMasteringValueMM(parseFloat(document.getElementById("SENSOR_LENGTH").value), parseFloat(document.getElementById("MASTER_FIXTURE_HEIGHT").value), parseFloat(document.getElementById("SMR").value)).toFixed(4);
  }

  function exportDetailsFile(option) {
    //console.log("@exportDetailsFile");
  ...
  function deleteFilesInDir(path) {
    // issue #35  This removes the files in the directory
  ...
  function writeDetailsFile() {
    ...
    for (let i = 0; i < E4PTdata.sets.length; i++) {
      contents += E4PTdata.sets[i].stage + "," + E4PTdata.sets[i].position + "," + checkValue(E4PTdata.sets[i].clearance, DETAILS_PRECISION) + "," + checkValue(E4PTdata.sets[i].max_clr, DETAILS_PRECISION) + "," + checkValue(E4PTdata.sets[i].min_clr, DETAILS_PRECISION) + "," + checkValue(E4PTdata.sets[i].med_clr, DETAILS_PRECISION) + "," + checkValue(E4PTdata.sets[i].std_clr, DETAILS_PRECISION) + "," + E4PTdata.sets[i].manualOverride + ",";
      if (E4PTdata.sets[i].manualOverride) {
        contents += E4PTdata.sets[i].overrideName + "," + E4PTdata.sets[i].overrideSSO;
      } else {
        contents += ",";
      }
      contents += "\n";
  ...
  function setIndicatorColor(color) {
    ...
    $("#CONNECTION_INDICATOR").removeClass(allColors).addClass(targetColor);
  ...
  function processE4PtData(msg) {
    ...
    // TEMP: log offset adjustment details
    getOffsetAdjustment();
    ...
    try {
      ...
      // E4PTdata.moving_average_enabled = false;
  ...
  function parse_data() {
    ...
    console.log("average clearance:", E4PTdata.clearance + "mm");
    console.log("average overall:", E4PTdata.overall_avg + "mm");
    console.log("data points:", E4PTdata.data.length);
  ...
  function clearArchive() {
    // issue #35 ==> make this erase local files.
    // erasing local files first, then clearing DB.
    deleteFilesInDir(cordova.file.documentsDirectory + "data");
    if (false) {
      // This method 'removes' the objects from the pouchdb.
      // However, pouchdb retains the objects and just marks them deleted.
      ...
      archive_db.destroy(function (err, response) {
        if (err) {
          console.log("Error destroying archive:", err);
          return;
        } else {
          //console.log("Database destroyed. Creating new empty database.");
          archive_db = new PouchDB("e4ptarchive", {
            revs_limit: 1,
            auto_compaction: true,
          });
          setTimeout(function () {
