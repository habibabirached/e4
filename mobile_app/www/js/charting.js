...
define(function(require, exports, module, sensorSettings) {
  ...
  const displayIntensityThresholdAndMeasurementRate = (chartConfig, measurement_rate, intensity_threshold, selected_frame_data) => {
        
      chartConfig.subtitle.text = '<span class="COL_FL FONT_TRANSPARENT">Intensity Threshold: 100%</span>;&nbsp;<span class="COL_FR">Measurement Rate: ' + measurement_rate + 'kHz</span><br/><span class="COL_FR">Intensity Threshold: ' + intensity_threshold + '%</span>;&nbsp;<span>' + chartConfig.subtitle.text + '</span><br/>'+
      '<span class="COL_FR"> FRAME : ' + selected_frame_data.frameName + ' </span>' +
      '<span class="COL_FR">     &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp      </span>' + 
      '<span class="COL_FR"> STAGE : ' + selected_frame_data.stageName + ' </span><br/>' + 
      '<span class="COL_FR"> blades : ' + selected_frame_data.bladeCount + ' </span>' + 
      '<span class="COL_FR">     &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp      </span>' + 
      '<span class="COL_FR"> RPM : ' + selected_frame_data.RPM + ' </span>' 
  }
